...
>
  ...
  <motion.div
    ...
    className="grid grid-cols-2 md:grid-cols-3 gap-4 my-10 dark:text-black"
  >
    {workData.map((project, index) => (
      ...
      >
        ...
        {/* Content Box */}
        <div className="absolute bottom-4 left-4 right-4 bg-white rounded-md py-2 px-3 flex items-center justify-between shadow-md transition group-hover:translate-y-[-10px]">
          <div>
